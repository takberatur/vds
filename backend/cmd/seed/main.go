...
func main() {
	...
	platforms := []model.Platform{
		...
		{ID: uuid.New(), Name: "Baidu", Slug: "baidu", Type: "baidu", ThumbnailURL: "https://console-storage.infrastructures.help/api/v1/buckets/video-downloader/objects/download?preview=true&prefix=platforms%2Fbaidu.png", Category: "video", URLPattern: stringPtr(`baidu\.com`), IsActive: true, IsPremium: false},
		...
		{ID: uuid.New(), Name: "Baidu To MP3", Slug: "baidu-to-mp3", Type: "baidu-to-mp3", ThumbnailURL: "https://console-storage.infrastructures.help/api/v1/buckets/video-downloader/objects/download?preview=true&prefix=platforms%2Fbaidu-mp3.png", Category: "audio", URLPattern: stringPtr(`baidu\.com`), IsActive: true, IsPremium: false},
		{ID: uuid.New(), Name: "Pinterest To MP3", Slug: "pinterest-to-mp3", Type: "pinterest-to-mp3", ThumbnailURL: "https://console-storage.infrastructures.help/api/v1/buckets/video-downloader/objects/download?preview=true&prefix=platforms%2Fpinterest-mp3.png", Category: "audio", URLPattern: stringPtr(`pinterest\.com`), IsActive: true, IsPremium: false},
