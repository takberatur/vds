...
export const load = async ({ locals, url, parent }) => {
	...
	const description = await deps.languageHelper.singleTranslate(i18n.privacy_policy_description({ site_name: settings?.WEBSITE.site_name || 'Video Downloader' }), lang) as SingleResponse;
