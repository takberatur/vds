...
<script lang="ts">
	...
	import CopyButton from '$lib/components/ui-extras/copy-button/copy-button.svelte';
	import ClipboardIcon from '@lucide/svelte/icons/clipboard';
	import TerminalIcon from '@lucide/svelte/icons/terminal';
	import * as Tooltip from '$lib/components/ui-extras/tooltip';
	import * as Tabs from '$lib/components/ui-extras/tabs';
