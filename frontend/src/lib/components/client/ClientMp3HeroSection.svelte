...
<div class="relative flex h-full w-full flex-col items-center justify-center overflow-x-clip">
	...
	>
		<div class="mx-auto max-w-4xl text-center">
			...
			>
				{i18n.mp3_text_hero_describtion()}
			</p>
