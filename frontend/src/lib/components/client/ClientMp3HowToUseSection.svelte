<script lang="ts">
	...
	const steps = [
		...
		{
			number: '3',
			title: i18n.mp3_text_how_to_download_step_save(),
				...
				{#each steps as step}
					<div class="relative">
						<div class="flex flex-col items-center text-center">
							...
							<h3 class="mb-3 text-xl font-bold capitalize">{step.title}</h3>
							<p class="text-muted-foreground capitalize">{step.description}</p>
						</div>
						{#if step.number !== '3'}
							<ArrowRight
