	...
	const features = [
		{
			...
			description: i18n.mp3_text_feature_title_download_fast_description()
		},
		{
			icon: Shield,
		...
		{
			icon: Video,
			title: i18n.mp3_text_feature_title_quality(),
			description: i18n.mp3_text_feature_title_quality_description()
		}
	];
</script>
		...
		<div class="container mx-auto px-4 md:max-w-6xl">
			<div class="mb-12 text-center">
				...
				<p bind:this={textElement} class="text-lg text-neutral-600 dark:text-neutral-400">
					{i18n.mp3_text_feature_why_choose_us_description()}
				</p>
			</div>
