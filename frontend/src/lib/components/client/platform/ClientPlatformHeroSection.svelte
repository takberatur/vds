	...
	>
		<div class="mx-auto max-w-4xl text-center">
			...
			>
				...
				{i18n.text_hero_tagline_name({ platform: platform?.name || 'N/A' })}
			</div>
			...
			>
				{i18n.text_hero_describtion_name({ platform: platform?.name || 'N/A' })}
			</p>
				...
				>
					<div class="mb-4 flex items-center justify-center gap-2">
						...
						<h2 class="text-center text-xl font-semibold">
							{i18n.text_input_link_download_label_name({ name: platform?.name || 'N/A' })}
						</h2>
					</div>
