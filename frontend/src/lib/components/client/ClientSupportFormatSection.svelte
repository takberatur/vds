...
<section
	...
	class="bg-linear-to-br from-blue-600 to-purple-600 py-16 text-white md:py-24"
>
	<div class="container mx-auto px-4 md:max-w-6xl">
		<div class="mx-auto max-w-4xl text-center">
			...
			<div class="grid gap-4 md:grid-cols-3">
				<div
					class="rounded-xl bg-white/10 p-6 backdrop-blur-sm dark:bg-white/5 dark:backdrop-blur-xl"
				>
