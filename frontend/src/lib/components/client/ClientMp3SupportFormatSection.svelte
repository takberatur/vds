		...
		<div class="container mx-auto flex justify-center px-4 md:max-w-6xl">
			<div class="w-full text-center">
				...
				<p bind:this={textElement} class="mb-8 text-lg text-blue-100">
					{i18n.mp3_text_supported_formats_description()}
				</p>
				...
				<div class="grid w-full gap-4 md:grid-cols-3">
					...
					>
						...
						<h3 class="mb-2 text-xl font-bold">{i18n.mp3_text_supported_formats_format()}</h3>
						<p class="text-mute-foreground text-sm">
							{i18n.mp3_text_supported_formats_format_description()}
						</p>
					</div>
					<div
						class="rounded-xl bg-white/10 px-6 py-10 shadow-lg backdrop-blur-md dark:bg-white/5 dark:backdrop-blur-xl"
					>
						<CheckCircle2 class="mx-auto mb-3 h-10 w-10" />
						<h3 class="mb-2 text-xl font-bold">{i18n.mp3_text_supported_formats_quality()}</h3>
						<p class="text-mute-foreground text-sm">
							{i18n.mp3_text_supported_formats_quality_description()}
						</p>
					</div>
					<div
						class="rounded-xl bg-white/10 px-6 py-10 shadow-lg backdrop-blur-md dark:bg-white/5 dark:backdrop-blur-xl"
					>
						<CheckCircle2 class="mx-auto mb-3 h-10 w-10" />
						<h3 class="mb-2 text-xl font-bold">{i18n.mp3_text_supported_formats_audio()}</h3>
						<p class="text-mute-foreground text-sm">
